...
**IMPORTANTE:** A configuração da planilha requer três arquivos distintos. Certifique-se de seguir as instruções detalhadas abaixo para configurar e utilizar a planilha corretamente.
...
*   **ScriptBotaoAmareloGravar:**
    *   Responsável pela funcionalidade dos botões "GRAVAR" nas abas "ENTRADA" e "SAÍDA", permitindo gravar os dados inseridos.
    *   Deve ser copiado e colado no editor de script da planilha recém criada após a execução das três etapas do `ScriptPlanilhaEstoqueControle`.
...
*   **ImagemBotaoAmareloGravar.png:**
    ...
    *   O `ScriptPlanilhaEstoqueControle` faz essa associação automaticamente durante a criação da planilha.
...
*   **Configuração de Abas:** Cria e formata as seguintes abas:
    *   **DETALHADO:** Contém tabelas de estoque, consumo setorial, consumo mensal, abastecimento mensal e informações detalhadas sobre lotes.
    ...
    *   **config:** Configurações gerais da planilha, como o ano atual, a lista de setores e lista de estoque com quatidade maior que zero.
...
1.  **Criar a Planilha (Proprietário):**
    ...
    *   Cole o código copiado no editor do Google App Script da sua conta Google.
    ...
    *   Ao concluir a terceira etapa, abra o editor de script da planilha recém-criada.
    *   Copie o código do arquivo `ScriptBotaoAmareloGravar` e cole no editor de script da planilha recém-criada.
...
*   **Listas Fixas:** A quantidade de setores é limitada a 10. A quantidade de entradas e saídas é limitada a 5000.
...
[Fernanda Paula de Carvalho](https://github.com/FernandaPaulaDeCarvalho) [Lattes](https://lattes.cnpq.br/3840867034129036) [Linkedin](www.linkedin.com/in/fernanda-paula-de-carvalho-phd-37599134)
