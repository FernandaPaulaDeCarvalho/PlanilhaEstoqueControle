...
const dataModificacao = "2025-11-10";
...
function segundaEtapa() {
  ...
  var instrucoes = [
    ...
    ["4- Colar no editor Google App Script da sua conta Google (Drive > Novo > Mais > Script do Google Apps);", null, null, null],
...
function terceiraEtapa() {
  ...
  // *** Formatação da aba "ENTRADA" ***
  var entrada = ss.getSheetByName("ENTRADA"); // Acessar a aba
  var protectionAba = entrada.protect().setDescription('ProtegerAba'); // Acessar a proteção da aba
  ...
  // *** Formatação da aba "SAÍDA" ***
  var saida = ss.getSheetByName("SAÍDA"); // Acessar a aba
  var protectionAba = saida.protect().setDescription('ProtegerAba'); // Acessar a proteção da aba
...
// Mensagem de conclusão
  Logger.log(
   ...
   "Acesse o editor de script da planilha recém criada e cole o código do ScriptBotaoAmareloGravar."
  );
